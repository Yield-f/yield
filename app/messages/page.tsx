...
//       //     hasNewUserMessage: false, // for admin notifications
//       //     hasNewMessage: false, // for user notifications
//       //   });
//       // } catch (error) {
//       //   console.error("Failed to clear message flags:", error);
//       // }
//       const lastMsg = msgs[msgs.length - 1];
// const updates: Record<string, any> = {};

// if (lastMsg?.sender === "admin") {
//   updates.hasNewMessage = false;
// }

// if (lastMsg?.sender === "user") {
//   updates.hasNewUserMessage = false;
// }
...
//     // Set hasNewUserMessage to true so admin gets notified
//     try {
//       const userDocRef = doc(db, "users", user.uid);
//       await updateDoc(userDocRef, {
...
//           <h1 className="text-2xl font-semibold mb-6 text-foreground">Chat</h1>
