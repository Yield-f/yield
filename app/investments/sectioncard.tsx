...
export function SectionCards() {
  ...
  return (
    <div className="*:data-[slot=card]:shadow-xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4 grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card lg:px-6 font-montserrat">
      ...
      {/* Markets Card */}
      {/* <Card className="@container/card font-montserrat transform transition-transform hover:scale-100 scale-95 bg-gradient-to-t from-green-500/10 to-green-100/10 dark:from-green-700/10 dark:to-card border-2 border-green-300 dark:border-green-600 shadow-md hover:shadow-lg animate-in fade-in duration-500">
        <CardHeader className="relative">
          <div className="flex items-center space-x-2">
            <CardDescription className="text-muted-foreground">
              Markets
